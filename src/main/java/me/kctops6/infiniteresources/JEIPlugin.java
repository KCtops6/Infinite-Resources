...
public class JEIPlugin implements IModPlugin {
    ...
    // Updated ResourceLocation instantiation for MC 1.21+
    private static final ResourceLocation PLUGIN_ID = ResourceLocation.fromNamespaceAndPath(InfiniteResources.MOD_ID, "jei_plugin");
